...
Drv::LinuxI2cDriverComponentImpl i2cDrv(FW_OPTIONAL_NAME("i2cDrv"));


Prototype::AccelComponentImpl Accel(FW_OPTIONAL_NAME("Accel"));
...
bool constructApp(bool dump, U32 port_number, char* hostname) {
    ...
    constructPrototypeArchitecture();
    ...
    //For checking if i2c is opened successfully
